        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted">
              <th className="px-4 py-3 text-start text-xs font-semibold text-foreground">{t("Client Name")}</th>
              <th className="px-4 py-3 text-start text-xs font-semibold text-foreground">{t("Phone Number")}</th>
              <th className="px-4 py-3 text-start text-xs font-semibold text-foreground">{t("Shipping ID")}</th>
              <th className="px-4 py-3 text-start text-xs font-semibold text-foreground">{t("History")}</th>
              <th className="px-4 py-3 text-start text-xs font-semibold text-foreground">{t("Total Debts")}</th>
