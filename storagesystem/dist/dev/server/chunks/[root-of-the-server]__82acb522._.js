...
async function GET() {
    try {
        const allProducts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query.products.findMany({
            with: {
                shipping: {
                    with: {
                        receiver: true,
...
async function POST(request) {
    try {
        ...
        const { product_name, cost, selling_price, group_item_price, storage, quantity, weight, sizes, colors, image, number_of_boxes, pice_per_box, shipping_id, size_of_box, total_box_size, box_code, extracted_pieces, currency, note } = body;
        if (!box_code || cost === undefined || cost === null || selling_price === undefined || selling_price === null) {
            return Response.json({
                error: "Missing required fields: box_code, cost, and selling_price are required"
            }, {
                status: 400
            });
        }
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].insert(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["products"]).values({
            product_name,
            cost: cost || 0,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__82acb522._.js.map