...
async function GET() {
    try {
        const allClients = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query.client.findMany({
            with: {
                shipping: true
            },
...
async function POST(request) {
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].insert(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"]).values({
            client_name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e33c2ca._.js.map