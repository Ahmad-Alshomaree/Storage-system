...
async function GET() {
    try {
        const allShipping = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query.shipping.findMany({
            with: {
                products: true,
                receiver: true,
                sender: true
...
async function POST(request) {
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].insert(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shipping"]).values({
            type,
            shipping_date,
            receiving_date,
            receiver_client_id,
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].insert(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["debits"]).values({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2dd8fb7d._.js.map