        ...
        "useAppData.useCallback[fetchData]": async ()=>{
            ...
            try {
                ...
                if (productsRes.ok) {
                    ...
                    setProducts(Array.isArray(data) ? data.map({
                ...
                if (clientsRes.ok) {
                    ...
                    setClients(Array.isArray(data) ? data.map({
                ...
                if (debitsRes.ok) {
                    ...
                    setDebits(Array.isArray(data) ? data.map({
...
_s(Home, "nmgII6PDrUIQO8hboq7UVVAfKsg=", false, function() {
    return [
...
//# sourceMappingURL=_7a8ac316._.js.map