...
function printShippingReceipt(shipping) {
    const printWin = window.open("", "_blank", "width=800,height=900");
    if (!printWin) return;
    const productsHtml = shipping.products && shipping.products.length > 0 ? shipping.products.map((p, i)=>`
      <tr>
    ...
    `).join("") : `<tr><td colspan="6" style="padding: 12px; text-align: center; color: #888;">No products attached</td></tr>`;
...
//# sourceMappingURL=lib_export-utils_ts_47d410c2._.js.map