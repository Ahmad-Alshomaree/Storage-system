...
function AddProductForm({ onSuccess }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$4_$40$babel$2b$core$40$7$2e$28$2e$5_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0_01c994d658d37eab1d33d0431b992ee5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddProductForm.useEffect": ()=>{
            const handleClickOutside = {
                "AddProductForm.useEffect.handleClickOutside": (event)=>{
                    ...
                    if (!target.closest('input[type="date"], input[type="datetime-local"], input[type="time"]')) {
                        ...
                        inputs.forEach({
                            "AddProductForm.useEffect.handleClickOutside": (input)=>input.blur()
                        }["AddProductForm.useEffect.handleClickOutside"]);
                    }
                }
            }["AddProductForm.useEffect.handleClickOutside"];
            document.addEventListener('click', handleClickOutside);
            return ({
                "AddProductForm.useEffect": ()=>document.removeEventListener('click', handleClickOutside)
            })["AddProductForm.useEffect"];
        }
    }["AddProductForm.useEffect"], []);
    ...
    const createRoom = async (roomName)=>{
        try {
            ...
            const newRoom = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tauri$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tauriApi"].createRoom(payload);
            setRooms((prev)=>[
                    ...prev,
                    newRoom
                ]);
...
_s(AddProductForm, "QJMpikULDaRfJXx9oBfyRMFH1Uc=", false, function() {
    return [
