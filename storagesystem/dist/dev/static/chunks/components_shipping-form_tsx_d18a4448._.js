...
function ShippingForm({ onSuccess }) {
            ...
            if (formData.type === 'output load') {
                ...
                const fetchProducts = {
                    "ShippingForm.useEffect.fetchProducts": async ()=>{
                        try {
                            const products = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tauri$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tauriApi"].getProducts();
    ...
    const saveIndividualProduct = async (product)=>{
        ...
        try {
            ...
            const savedProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tauri$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tauriApi"].createProduct(productData);
        ...
        try {
            ...
            if (formData.receiver) {
                ...
                if (existingClient && !newlyAddedClients.has(existingClient.id)) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tauri$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tauriApi"].updateClient(existingClient.id, {
...
_s(ShippingForm, "p/eHcowo5/ip4q15fwGXUKSENeQ=", false, function() {
    return [
